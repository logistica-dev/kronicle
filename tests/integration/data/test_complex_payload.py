...
class BatchAccessPolicy(BaseModel):
    visibility: str = Field(..., description="e.g., 'public' or 'LOFAR KSP'")
...
class ObservationPayload(KronicableSample):
    ...
    added_by: RimsUser = Field(default=RimsUser(email="community@kronicle.app"), description="...")
    dataset_id: str = Field(..., description="Unique identifier for the dataset.")
    instrument_name: str = Field(..., description="Name of the instrument used for the observation.")
    computing_infrastructure: str | None = Field(None, description="Computing infrastructure name.")
    publication_details: str | None = Field(None, alias="publication details", description="BibTeX or ORCID ID.")
    rims_client_version: str = Field(..., alias="RIMS client version", description="Version of the RIMS client.")
